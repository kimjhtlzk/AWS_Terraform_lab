locals {
  aws_alb = {
    # --------------------------------------------------------------------------
    seoul = {
      asdasd-staging-review-alb-01 = {
        vpc                 = "vpc-asd-staging"
        lb_type             = "external"   # "external" or "internal"
        idle_timeout        = "60"
        security_groups     = [
            "asdasda-staging-ext-alb-sg",
        ]
        ...
        listener = { # certificate_name값은 acm.tf로 정의된 인증서라면 acm.tf에서 정의한 이름을, 그렇지 않을 경우 arn을 직접 입력합니다.
          1 = {
            ...
            certificate_name    = "arn:aws:acm:ap-northeast-2:456456345:certificate/456456-142d-4885-bcfa-45645645645"
          }
          2 = {
            port                = 30010
            protocol            = "HTTPS"
            target_group        = "asdsad-staging-tg-02"
            certificate_name    = "arn:aws:acm:ap-northeast-2:45645645:certificate/456546-142d-4885-bcfa-45645645654"
          }
